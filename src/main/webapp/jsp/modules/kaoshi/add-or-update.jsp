            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">考试管理</li>
                        <li class="breadcrumb-item active">编辑考试</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>开始时间</label>
                                       <input id="startTime-input" name="startTime" type="text" class="form-control layui-input">
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>结束时间</label>
                                       <input id="endTime-input" name="endTime" type="text" class="form-control layui-input">
                                   </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("kaoshi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addkaoshi');
    ...
    // 获取当前详情
    function getDetails() {
        var addkaoshi = window.sessionStorage.getItem("addkaoshi");
        if (addkaoshi != null && addkaoshi != "" && addkaoshi != "null") {
            window.sessionStorage.removeItem('addkaoshi');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("kaoshi/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#startTime-input").val(ruleForm.startTime);
        $("#endTime-input").val(ruleForm.endTime);
