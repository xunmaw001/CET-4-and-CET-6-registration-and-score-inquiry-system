            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">考试列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                 
                                        <label>
                                            考试名
                                            <input type="text" id="kaoshiNameSearch" style="width: 140px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //报名按钮
        var baomingBtn = document.createElement('button');
        var baomingAttr = 'baoming(' + item.id + ')';
        baomingBtn.setAttribute("type", "button");
        baomingBtn.setAttribute("class", "btn btn-warning btn-sm 审核");
        baomingBtn.setAttribute("onclick", baomingAttr);
        baomingBtn.innerHTML = "报名"
        btnGroup.appendChild(baomingBtn)
        //删除按钮
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("kaoshi/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addkaoshi", "addkaoshi");
        window.location.href = "add-or-update.jsp"
    }
