            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">考场登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="startTime" name="startTime" class="form-control"
                                                   v-model="ruleForm.startTime" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="endTime" name="endTime" class="form-control"
                                                   v-model="ruleForm.endTime" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="laoshiIdNumber" name="laoshiIdNumber" class="form-control"
                                                   v-model="ruleForm.laoshiIdNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>民族</label>
                                            <input id="laoshiNation" name="laoshiNation" class="form-control"
                                                   v-model="ruleForm.laoshiNation" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="politicsValue" name="politicsValue" class="form-control"
                                               v-model="ruleForm.politicsValue" readonly>
                                    </div>


                                        <div class="form-group col-md-6">
                                            <label>家庭住址</label>
                                            <input id="laoshiAddress" name="laoshiAddress" class="form-control"
                                                   v-model="ruleForm.laoshiAddress" readonly>
                                        </div>
                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaochangName" name="kaochangName" class="form-control"
                                               v-model="ruleForm.kaochangName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaoshiNumber" name="kaoshiNumber" class="form-control"
                                               v-model="ruleForm.kaoshiNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaochangAddress" name="kaochangAddress" class="form-control"
                                               v-model="ruleForm.kaochangAddress" readonly>
                                    </div>
