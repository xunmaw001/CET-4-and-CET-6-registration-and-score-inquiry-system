            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">成绩登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <%--<div class="form-group col-md-6">--%>
                                            ...
                                            <%--<input id="kaoshiId" name="kaoshiId" class="form-control"--%>
                                                   <%--v-model="ruleForm.kaoshiId" readonly>--%>
                                        <%--</div>--%>
                                        ...
                                        <%--<div class="form-group col-md-6">--%>
                                            ...
                                            <%--<input id="laoshiId" name="laoshiId" class="form-control"--%>
                                                   <%--v-model="ruleForm.laoshiId" readonly>--%>
                                        <%--</div>--%>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="nation" name="nation" class="form-control"
                                                   v-model="ruleForm.nation" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="kaochangId" name="kaochangId" v-model="ruleForm.kaochangId" readonly type="hidden">
                                ...
                                <div class="form-group col-md-6">
                                    <label>成绩类型</label>
                                    <input id="chengjiValue" name="chengjiValue" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fraction" name="fraction" class="form-control"
                                               v-model="ruleForm.fraction" readonly>
                                    </div>
