            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">老师管理</li>
                        <li class="breadcrumb-item active">编辑老师</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="laoshiIdNumber" name="laoshiIdNumber" class="form-control"
                                           onchange="laoshiIdNumberChickValue(this)"  placeholder="身份证号">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>手机号</label>
                                   ...
                                   <div class="form-group col-md-6">
                                       ...
                                       <input name="file" type="file" id="laoshiPhotoupload"
                                              class="form-control-file">
                                       <input name="laoshiPhoto" id="laoshiPhoto-input" type="hidden">
                                   </div>
                                    <div class="form-group col-md-6">
                                        <label>民族</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("laoshi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addlaoshi');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function laoshiIdNumberChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                laoshiName: "required",
                sexTypes: "required",
                laoshiIdNumber: "required",
                phone: "required",
                laoshiPhoto: "required",
                laoshiNation: "required",
                politicsTypes: "required",
                laoshiAddress: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                laoshiName: "姓名不能为空",
                sexTypes: "性别不能为空",
                laoshiIdNumber: "身份证号不能为空",
                phone: "手机号不能为空",
                laoshiPhoto: "照片不能为空",
                laoshiNation: "民族不能为空",
                politicsTypes: "政治面貌不能为空",
                laoshiAddress: "家庭住址不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addlaoshi = window.sessionStorage.getItem("addlaoshi");
        if (addlaoshi != null && addlaoshi != "" && addlaoshi != "null") {
            window.sessionStorage.removeItem('addlaoshi');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("laoshi/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
