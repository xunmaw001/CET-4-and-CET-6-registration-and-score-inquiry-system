            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">老师列表</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            身份证号
                                            <input type="text" id="laoshiIdNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="身份证号" aria-controls="tableId">
                                        </label>
                                 
                                        <label>
                                            手机号
                                            <input type="text" id="phoneSearch" style="width: 140px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //民族
        var laoshiNationCell = document.createElement('td');
        laoshiNationCell.innerHTML = item.laoshiNation;
        row.appendChild(laoshiNationCell);
        ...
        //家庭住址
        var laoshiAddressCell = document.createElement('td');
        laoshiAddressCell.innerHTML = item.laoshiAddress;
        row.appendChild(laoshiAddressCell);
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addlaoshi", "addlaoshi");
        window.location.href = "add-or-update.jsp"
    }
