    ...
    */
    ...
    public R save(@RequestBody LaoshiEntity laoshi, HttpServletRequest request){
        ...
        if(laoshiEntity==null){
            ...
            return R.error(511,"老师手机号或者身份证号或者账户已经被使用");
        }
    }
...
//    public R register(@RequestBody LaoshiEntity yonghu){
//        //    	ValidatorUtils.validateEntity(user);
//        if(laoshiService.selectOne(new EntityWrapper<LaoshiEntity>().eq("username", laoshi.getUsername()).orNew().eq("phone",laoshi.getPhone()).orNew().eq("id_number",laoshi.getLaoshiIdNumber())) !=null) {
//            return R.error("老师已存在或手机号身份证号已经被使用");
//        }
...
//    }
    ...
    public R getCurrYonghu(HttpServletRequest request){
        ...
        LaoshiEntity laoshiEntity = laoshiService.selectById(id);
        return R.ok().put("data", laoshiEntity);
    }
