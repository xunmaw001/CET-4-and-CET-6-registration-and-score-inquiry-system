    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(chengji !=null){
            ...
            //级联表
            KaochangEntity kaochang = kaochangService.selectById(chengji.getKaochangId());
            if(kaochang != null){
                BeanUtils.copyProperties( kaochang , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                view.setKaochangId(kaochang.getId());
            }
            //级联表
    ...
    */
    ...
    public R save(@RequestBody ChengjiEntity chengji, HttpServletRequest request){
        ...
        Wrapper<ChengjiEntity> queryWrapper = new EntityWrapper<ChengjiEntity>()
            ...
            .eq("kaochang_id", chengji.getKaochangId())
            .eq("kaoshi_types", chengji.getKaoshiTypes())
